...
mkdir -p src test docs/superplex/plans

# Create a simple implementation plan
cat > docs/superplex/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/superplex/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/superplex/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"superplex:subagent-driven-development"' "$SESSION_FILE"; then
