...
## Is this a Superplex issue or a platform issue?
<!-- Superplex is a plugin. Some reported "bugs" are actually issues
     in the underlying platform or model. If you're not sure, try
     reproducing without Superplex installed.

     If the problem persists without Superplex, file the issue with
     your platform instead. -->

- [ ] I confirmed this issue does not occur without Superplex installed
