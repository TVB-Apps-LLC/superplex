...
const SUPERPLEX_VERSION = readSuperplexVersion();
...
function brandMarkup() {
  const version = escapeHtmlText(SUPERPLEX_VERSION);
  const text = 'Superplex v' + version;

  return '<div class="brand"><a href="https://github.com/TVB-Apps-LLC/superplex"><span class="brand-copy">' + text + '</span></a></div>';
}
